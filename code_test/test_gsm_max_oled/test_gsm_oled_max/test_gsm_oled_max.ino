...
#define GSM_PIN ""
#define ADMIN_NUMBER "+201551526441"
#define TINY_GSM_DEBUG SerialMon
...
void setup() {
    ...
    String smsMessage = "Hello from Smart Bracelet";
    modem.sendSMS(ADMIN_NUMBER, smsMessage);
    Serial.println(smsMessage);  // Debugging
        ...
        if(!isnan(current_diff) && !isnan(last_diff)) {
            ...
            if(crossed && current_diff < kEdgeThreshold) {
                if(last_heartbeat != 0 && crossed_time - last_heartbeat > 300) {
                    // Calculate Heart Rate (BPM) and SpO2
                    ...
                    if(bpm > 50 && bpm < 250) {
                        ...
                        if(kEnableAveraging) {
                            ...
                            if(averager_bpm.count() >= kSampleThreshold) {
                                ...
                                // Send values via SMS
                                String message = "Heart Rate: " + String(average_bpm) + " BPM, SpO2: " + String(average_spo2) + "%";
                            ...
                            // Send current values
                            String message = "Heart Rate: " + String(bpm) + " BPM, SpO2: " + String(spo2) + "%";
                            modem.sendSMS(ADMIN_NUMBER, message);
                            Serial.println("Message sent: " + message);  // Debugging
...
void initDrawScreen(void) {
    ...
    display.println(F(" SmartCare Diabetes"));
    display.println(F(""));
